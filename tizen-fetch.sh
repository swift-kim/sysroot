...
fetch_tizen_pkgs armv7l capi-base-common-devel capi-base-utils-devel libdlog-devel coregl-devel ecore-core-devel ecore-wl2-devel eina-devel efl-devel eo-devel wayland-devel libxkbcommon-devel jsoncpp-devel emile-devel evas-devel ecore-imf-devel ecore-imf-evas-devel # for embedder (devel)
fetch_tizen_pkgs armv7l libtdm libtbm libtdm-client libtdm-devel libtdm-client-devel libtbm-devel # for embedder (vsync)
fetch_tizen_pkgs armv7l capi-base-utils libwayland-client ecore-wl2 coregl libdlog ecore-core ecore-input jsoncpp emile evas ecore-imf ecore-imf-evas # for embedder (libs)
